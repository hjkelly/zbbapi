...
// UpdateID finds the current Job by ID, updates all its user-updatable fields, and saves it again.
func UpdateID(id string, input models.Job) (*models.Job, error) {
	ds := newDatastore()
